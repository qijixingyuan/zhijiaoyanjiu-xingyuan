...
const SOURCES: CrawlSource[] = [
  ...
  // ── 专门栏目源（2026-09-14 批量调研，补各省职教政策主渠道）──
  {
    name: "安徽省职成处", province: "安徽省",
    url: "https://jyt.ah.gov.cn/tsdw/zyycrjyc/tzgg/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "河南省职成网", province: "河南省",
    url: "https://vae.ha.cn/templates/zcjgw/2/10/60_1_2025.htm",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
  },
  {
    name: "云南省公示公告", province: "云南省",
    url: "https://jyt.yn.gov.cn/zfxxgk/fdzdgknr/gsgg/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "重庆市公告公示", province: "重庆市",
    url: "http://jw.cq.gov.cn/zwxx_209/gggs/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "广西壮族自治区通知公告", province: "广西壮族自治区",
    url: "http://jyt.gxzf.gov.cn/zfxxgk/fdzdgknr/tzgg_58179/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "甘肃省职成处文件", province: "甘肃省",
    url: "http://jyt.gansu.gov.cn/jyt/c020802/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "新疆维吾尔自治区公示公告", province: "新疆维吾尔自治区",
    url: "https://jyt.xinjiang.gov.cn/edu/gsgg/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "黑龙江省通知公告", province: "黑龙江省",
    url: "http://jyt.hlj.gov.cn/jyt/c110481/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "宁夏回族自治区通知公告", province: "宁夏回族自治区",
    url: "https://jyt.nx.gov.cn/xwdt/tzgg/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "山西省职成处", province: "山西省",
    url: "https://jyt.shanxi.gov.cn/jgsz/jgcs/zyjyc/csgz7/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "四川省职教处文件", province: "四川省",
    url: "http://edu.sc.gov.cn/scedu/c100495/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "河北省职业教育栏目", province: "河北省",
    url: "http://jyt.hebei.gov.cn/col/1533807643547/index.html",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "贵州省职业教育栏目", province: "贵州省",
    url: "https://jyt.guizhou.gov.cn/zwgk/zdlyxxgk/zyjy/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "上海市职业教育频道", province: "上海市",
    url: "https://edu.sh.gov.cn/zyjy/index.html",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "内蒙古自治区职业教育栏目", province: "内蒙古自治区",
    url: "https://jyt.nmg.gov.cn/zfxxgk/fdzdgknr/zdlyxx/zyjy_17638/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "海南省公示公告", province: "海南省",
    url: "https://edu.hainan.gov.cn/edu/0400/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "辽宁省最新通知", province: "辽宁省",
    url: "https://jyt.ln.gov.cn/jyt/gk/zxtz/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "江西省通知公告", province: "江西省",
    url: "http://jyt.jiangxi.gov.cn/jxjyw/tzgg785/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },
  {
    name: "青海省通知公告", province: "青海省",
    url: "http://jyt.qinghai.gov.cn/gk/tzgg/",
    waitFor: "a[href]",
    waitUntil: "domcontentloaded",
    paginate: { type: "index_N", maxPages: 10 },
  },

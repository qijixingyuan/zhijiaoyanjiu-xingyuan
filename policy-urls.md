...
| 省份 | 教育厅首页 | 状态 |
|------|------|:--:|
| 山西省 | `jyt.shanxi.gov.cn` | 404 |
| 广西壮族自治区 | `jyt.gxzf.gov.cn` | SSL 错误 |
| 陕西省 | `jyt.shaanxi.gov.cn` | 404 |
| 甘肃省 | `jyt.gansu.gov.cn` | 412 |
| 青海省 | `jyt.qinghai.gov.cn` | 空页面 |
| 宁夏回族自治区 | `jyt.nx.gov.cn` | 405 |
| 新疆维吾尔自治区 | `jyt.xinjiang.gov.cn` | 404 |
| 西藏自治区 | `edu.xizang.gov.cn` | 连接关闭 |
